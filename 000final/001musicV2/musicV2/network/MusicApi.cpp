...
MusicApi::MusicApi(QObject *parent)
    : QObject(parent), m_nam(new QNetworkAccessManager(this)), m_timeout(new QTimer(this))
{
...
void MusicApi::onReply()
{
    ...
    case 429:
        ...
        break;
    case 500:
        msg = QStringLiteral("音源服务器错误: ") + obj.value("message").toString(QStringLiteral("未返回 URL"));
        break;
    default:
